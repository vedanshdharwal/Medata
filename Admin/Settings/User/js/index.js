...
const setupGuides = (data,user) => {
	...
	if(data.length){
		...
		data.forEach(doc => {
			...
			Height [in cms]<br>
					<input type="number" placeholder=${guide.height} name="height" id="height"><br>
					
			Weight [in Kgs]<br>
			<input type="number" placeholder=${guide.weight} name="weight" id="weight"><br>
					
			Birth Defects / Serious Health Issue <br>		
			<textarea name="health" placeholder=${guide.health} cols="30" rows="5" id="health"></textarea>	<br></br>		
			
			Allergy  [if any]<br>		
			<textarea name="allergy" placeholder=${guide.allergy} cols="30" rows="5" id="allergy"></textarea>	<br></br>
